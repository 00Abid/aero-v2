    ...
    return (
        <>
            <SEOHead
                ...
                description="Terms and conditions for using AERO ENTERPRISES sheet metal supply services. Read our service agreement, warranties, and legal terms."
            ...
            <div className="bg-white">
                ...
                <div className="max-w-4xl mx-auto px-4 py-16">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            These Terms of Service ("Terms") govern your use of AERO ENTERPRISES' website and services. By accessing or using our services, you agree to be bound by these Terms.
                        </p>
                    </div>

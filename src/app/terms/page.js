            ...
            <div className="max-w-5xl mx-auto px-6 py-20">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
                    {highlights.map((item, index) => (
                        <div key={index} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all border-t-4 border-t-black">
                            <div className="text-black mb-4">{item.icon}</div>
                            <h3 className="text-sm font-black text-black mb-2 uppercase tracking-tight">{item.title}</h3>
                            <p className="text-gray-500 text-xs leading-relaxed font-medium">{item.content}</p>
                        </div>
                    ))}
                </div>
                ...
                <div className="space-y-12 prose prose-slate max-w-none">
                    <section>
                        <h2 className="text-2xl font-black text-black mb-6 uppercase tracking-tight flex items-center gap-3">
                            <span className="text-blue-600 text-3xl">01</span> Scope of Industrial Services
                        </h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-black text-black mb-6 uppercase tracking-tight flex items-center gap-3">
                            <span className="text-blue-600 text-3xl">03</span> Quality & Liability
                        </h2>
                    ...
                    <section className="border-t border-gray-100 pt-12">
                        <h2 className="text-2xl font-black text-black mb-6 uppercase tracking-tight">04. Dispute Resolution</h2>
                ...
                <div className="mt-20 p-10 border-2 border-black rounded-[2.5rem] flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="text-right flex flex-col items-center md:items-end">
                        <a href="mailto:aeroenterprises00@gmail.com" className="text-lg font-black text-blue-600 hover:underline">aeroenterprises00@gmail.com</a>
